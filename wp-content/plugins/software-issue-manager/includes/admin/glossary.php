...
<div class="inside">
<table class="form-table"><p class"lead"><?php _e('An issue is anything that might affect the project meeting its goals such as bugs, tasks, and feature requests that occur during a project\'s life cycle.', 'software-issue-manager'); ?></p><tr>
...
<div class="accordion-section-content">
<div class="inside">
<table class="form-table"><p class"lead"><?php _e('A project is a collection of related issues. Projects have a unique version number, specific start and end dates.', 'software-issue-manager'); ?></p><tr>
<th><?php _e('Content', 'software-issue-manager'); ?></th>
<td><?php _e(' Content does not have a default value. ', 'software-issue-manager'); ?></td>
</tr><tr>
