		...
		<ul class="nav navbar-nav">
			<li class="nav-item"><a class="page-link"
				href="<?php echo get_admin_url() . '?page=user_home'; ?>"><span
					class="button-primary">Change Registration Period: <?php if (isset($regyear)) echo $regyear; ?></span></a>
			</li>
		</ul>
	</nav>
</div>
          ...
          <tr>
              ...
              <?php echo $row['FatherFirstName'];?>
               ...
               <?php if (current_user_can('iss_admin')) {    ?>
                 <a
						href="admin.php?page=archived_home&uid=<?php echo $row['ID'];?>">
                ...
                <a
						href="admin.php?page=view_parent&id=<?php echo $row['ID'];?>"> <span
							style="padding-left: 10px; white-space: nowrap;"> <i
								class="glyphicon glyphicon-eye-open"></i> View </a></span> <a
						href="admin.php?page=view_parent&id=<?php echo $row['ID'];?>"> <span
							style="padding-left: 10px; white-space: nowrap;"><i
								class="glyphicon glyphicon-print"></i> Print</a></span>
