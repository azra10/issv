...
CREATE TABLE IF NOT EXISTS `qv84_iss_parent` (
  ...
  `HomeState` varchar(5) DEFAULT 'CA' COMMENT 'Home State',
  ...
  `MotherState` varchar(5) DEFAULT 'CA' COMMENT 'Mother State',
...
CREATE VIEW `qv84_iss_parents` AS select `qv84_iss_payment`.`PaymentID` AS `ParentViewID`,
`qv84_iss_parent`.`ParentID` AS `ParentID`,
`qv84_iss_parent`.`FatherFirstName` AS `FatherFirstName`,
`qv84_iss_parent`.`FatherLastName` AS `FatherLastName`,
`qv84_iss_parent`.`FatherEmail` AS `FatherEmail`,
`qv84_iss_parent`.`FatherWorkPhone` AS `FatherWorkPhone`,
`qv84_iss_parent`.`FatherCellPhone` AS `FatherCellPhone`,
`qv84_iss_parent`.`HomeStreetAddress` AS `HomeStreetAddress`,
`qv84_iss_parent`.`HomeCity` AS `HomeCity`,
`qv84_iss_parent`.`HomeState` AS `HomeState`,
`qv84_iss_parent`.`HomeZip` AS `HomeZip`,
`qv84_iss_parent`.`HomePhone` AS `HomePhone`,
`qv84_iss_parent`.`FamilySchoolStartYear` AS `FamilySchoolStartYear`,
`qv84_iss_parent`.`SchoolEmail` AS `SchoolEmail`,
`qv84_iss_parent`.`MotherFirstName` AS `MotherFirstName`,
`qv84_iss_parent`.`MotherLastName` AS `MotherLastName`,
`qv84_iss_parent`.`MotherStreetAddress` AS `MotherStreetAddress`,
`qv84_iss_parent`.`MotherCity` AS `MotherCity`,
`qv84_iss_parent`.`MotherState` AS `MotherState`,
`qv84_iss_parent`.`MotherZip` AS `MotherZip`,
`qv84_iss_parent`.`MotherEmail` AS `MotherEmail`,
`qv84_iss_parent`.`MotherHomePhone` AS `MotherHomePhone`,
`qv84_iss_parent`.`MotherWorkPhone` AS `MotherWorkPhone`,
`qv84_iss_parent`.`MotherCellPhone` AS `MotherCellPhone`,
`qv84_iss_parent`.`EmergencyContactName1` AS `EmergencyContactName1`,
`qv84_iss_parent`.`EmergencyContactPhone1` AS `EmergencyContactPhone1`,
`qv84_iss_parent`.`EmergencyContactName2` AS `EmergencyContactName2`,
`qv84_iss_parent`.`EmergencyContactPhone2` AS `EmergencyContactPhone2`,
`qv84_iss_parent`.`ShareAddress` AS `ShareAddress`,
`qv84_iss_parent`.`TakePicture` AS `TakePicture`,
`qv84_iss_parent`.`ParentStatus` AS `ParentStatus`,
`qv84_iss_parent`.`ParentNew` AS `ParentNew`,
`qv84_iss_parent`.`SpecialNeedNote` AS `SpecialNeedNote`,
`qv84_iss_payment`.`RegistrationYear` AS `RegistrationYear`,
`qv84_iss_payment`.`PaymentInstallment1` AS `PaymentInstallment1`,
`qv84_iss_payment`.`PaymentMethod1` AS `PaymentMethod1`,
`qv84_iss_payment`.`PaymentDate1` AS `PaymentDate1`,
`qv84_iss_payment`.`PaymentInstallment2` AS `PaymentInstallment2`,
`qv84_iss_payment`.`PaymentMethod2` AS `PaymentMethod2`,
`qv84_iss_payment`.`PaymentDate2` AS `PaymentDate2`,
`qv84_iss_payment`.`TotalAmountDue` AS `TotalAmountDue`,
 `qv84_iss_payment`.`FinancialAid` AS `FinancialAid`,
 `qv84_iss_payment`.`PaidInFull` AS `PaidInFull`,
 `qv84_iss_payment`.`RegistrationCode` AS `RegistrationCode`,
 `qv84_iss_payment`.`RegistrationExpiration` AS `RegistrationExpiration`,
 `qv84_iss_payment`.`RegistrationComplete` AS `RegistrationComplete`,
 `qv84_iss_payment`.`Comments` AS `Comments` 
 from (`qv84_iss_parent` join `qv84_iss_payment` on((`qv84_iss_parent`.`ParentID` = `qv84_iss_payment`.`ParentID`)));
